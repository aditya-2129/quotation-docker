...
/**
 * Button Component
 * A premium reusable button with multiple variants and states.
 */
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary: "bg-black text-white hover:bg-zinc-800 focus:ring-black dark:bg-white dark:text-black dark:hover:bg-zinc-200",
    ...
    ghost: "bg-transparent text-zinc-500 hover:text-black hover:bg-zinc-50 dark:hover:bg-zinc-900 dark:hover:text-white",
  };
